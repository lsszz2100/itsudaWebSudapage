...
.panel-success{border-color:#e5e5e5;}
.panel-success>.panel-body{background-color:#f3f3f3;}
.panel-success>.panel-body .title{font-size:1.25em; margin-top:10px;}
.panel-footer>p{text-align:right;}
</style>
