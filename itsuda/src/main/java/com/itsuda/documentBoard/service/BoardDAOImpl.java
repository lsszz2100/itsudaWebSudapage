package com.itsuda.documentBoard.service;
...
public class BoardDAOImpl implements BoardDAO{
	...
	private static final String namespace="itsuda.documentBoard";
	...
	//최근 게시물 갯수
	@Override
	public List<BoardVO> lastestPageNum() {
		return sql.selectList(namespace+".lastestPageNum");
	}
	//파일 업로드 
	@Override
	public void fileInsert(BoardFileVO file) throws Exception {
		 sql.insert(namespace+".fileInsert", file);
	}
	//파일 리스트
	@Override
	public List<BoardFileVO> fileDetail(int seq) throws Exception {
		return sql.selectList(namespace+".fileDetail", seq);
	}
	//파일 다운로드
	@Override
	public BoardFileVO fileDownload(int upSeq, int seq) throws Exception {
