...
import com.itsuda.issueManageBoard.service.Reply.IsBoardReplyService;
...
@Log4j
@RestController
@RequestMapping("/IsReplies")
public class IsBoardReplyController extends UriMap{
	
	private final IsBoardReplyService replyService;
	
	@Inject
	public IsBoardReplyController(IsBoardReplyService replyService) {
...
//	댓글 등록처리 
	...
	public ResponseEntity<String> register(@RequestBody IsBoardReplyVO replyVO){
		log.info("댓글 등록처리");
...
//	대댓글 등록처리 
	...
	public ResponseEntity<String> comments(String pReplyNo, String pSeq, String cText, String cWriter, String proSeq){
		log.info("대댓글 등록처리");
		ResponseEntity<String> entity = null;
		IsBoardReplyVO vo = new IsBoardReplyVO();
...
//	댓글 목록 
	...
	public ResponseEntity<List<IsBoardReplyVO>> list(@PathVariable("seq") Integer seq){
		log.info("댓글 목록");
		ResponseEntity<List<IsBoardReplyVO>> entity = null;
...
//	댓글 수정 처리
	...
	public ResponseEntity<String> update(@PathVariable("replyNo") Integer replyNo, @RequestBody IsBoardReplyVO replyVO){
		log.info("댓글 수정 처리");
		ResponseEntity<String> entity = null;
		try {
...
//	댓글 목록 출력 및 페이징 처리 
	...
	public ResponseEntity<Map<String, Object>> listPaging(@PathVariable("seq") Integer seq
		...
		try {
			...
			List<IsBoardReplyVO> replies = replyService.getRepliesPaging(seq, searchCriteria);
