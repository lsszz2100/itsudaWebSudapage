...
@Repository
public class dbBoardReplyDAOImpl implements dbBoardReplyDAO{

	private static String NAMESPACE ="itsuda.dbOjectBoard";
    ...
    @Override
    public List<dbBoardReplyVO> listPaging(Integer seq, Criteria criteria) throws Exception{
