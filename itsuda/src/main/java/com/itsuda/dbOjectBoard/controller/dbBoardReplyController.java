...
import com.itsuda.dbOjectBoard.service.Reply.dbBoardReplyService;
...
@Log4j
@RestController
@RequestMapping("/DBReplies")
public class dbBoardReplyController extends UriMap{
	
	private final dbBoardReplyService replyService;
	
	@Inject
	public dbBoardReplyController(dbBoardReplyService replyService) {
...
//	댓글 등록처리 
	...
	public ResponseEntity<String> register(@RequestBody dbBoardReplyVO replyVO){
		log.info("댓글 등록처리");
...
//	대댓글 등록처리 
	...
	public ResponseEntity<String> comments(String pReplyNo, String pSeq, String cText, String cWriter, String proSeq){
		log.info("대댓글 등록처리");
		ResponseEntity<String> entity = null;
		dbBoardReplyVO vo = new dbBoardReplyVO();
...
//	댓글 목록 
	...
	public ResponseEntity<List<dbBoardReplyVO>> list(@PathVariable("seq") Integer seq){
		log.info("댓글 목록");
		ResponseEntity<List<dbBoardReplyVO>> entity = null;
...
//	댓글 수정 처리
	...
	public ResponseEntity<String> update(@PathVariable("replyNo") Integer replyNo, @RequestBody dbBoardReplyVO replyVO){
		log.info("댓글 수정 처리");
		ResponseEntity<String> entity = null;
		try {
...
//	댓글 목록 출력 및 페이징 처리 
	...
	public ResponseEntity<Map<String, Object>> listPaging(@PathVariable("seq") Integer seq
		...
		try {
			...
			List<dbBoardReplyVO> replies = replyService.getRepliesPaging(seq, searchCriteria);
