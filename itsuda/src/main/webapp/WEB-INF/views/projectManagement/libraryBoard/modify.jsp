		...
		<div id="content-wrapper">
			<div class="container-fluid">
				...
				<div class="card-header">
						<i class="fas fa-table"></i> 라이브러리 수정
					</div>
					<div class="card-body">

						<form action="../libraryBoard/LiModifyAction" method="post" enctype="multipart/form-data">
							...
							<div>
								...
								<button type="button" class="btn btn-secondary"
									onclick="location.href='../libraryBoard/LiDetail?page=${param.page}&perPageNum=${param.perPageNum}&keyword=${param.keyword}&seq=${param.seq }&proSeq=${proSeq }'">이전으로</button>
							</div>
						</form>
					</div>
