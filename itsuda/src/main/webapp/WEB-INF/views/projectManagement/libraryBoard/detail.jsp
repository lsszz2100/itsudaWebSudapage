							...
							<div class="card">
								...
								<div class="card-body">
									<button type="button" class="btn btn-info" 
										onclick="location.href='../libraryBoard/LiModify?page=${param.page}&perPageNum=${param.perPageNum}&keyword=${param.keyword}&seq=${param.seq}'">수정</button>
									<button type="button" class="btn btn-info" 
										onclick="location.href='../libraryBoard/LiDelete?page=${param.page}&perPageNum=${param.perPageNum}&keyword=${param.keyword}&seq=${param.seq}'">삭제</button>
									<button type="button" class="btn btn-info"
										onclick="location.href='../libraryBoard/LiMain?page=${param.page}&perPageNum=${param.perPageNum}&keyword=${param.keyword}'">목록으로</button>
								</div>
