		...
		<div id="content-wrapper">
			<div class="container-fluid">
				...
				<div class="card-header">
						<i class="fas fa-table"></i> 이슈 등록
					</div>
					<div class="card-body">

						<form action="<c:url value='/issueManageBoard/IsInsertAction'/>"
							...
							<div>
								...
								<button type="button" class="btn btn-secondary" style="margin-top:15px; float:right;"
									onclick="location.href='../issueManageBoard/IsMain?page=${param.page }&perPageNum=10&keyword=&team=${param.team}&proSeq=${proSeq }'">목록으로</button>
