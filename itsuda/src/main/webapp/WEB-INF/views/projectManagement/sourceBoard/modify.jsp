		...
		<div id="content-wrapper">
			<div class="container-fluid">
				...
				<div class="card-header">
						<i class="fas fa-table"></i> 버전 별 소스 수정
					</div>
					<div class="card-body">

						<form action="../sourceBoard/SoModifyAction" method="post" enctype="multipart/form-data">
							...
							<div>
								...
								<button type="button" class="btn btn-secondary"
									onclick="location.href='../sourceBoard/SoDetail?page=${param.page}&perPageNum=${param.perPageNum}&keyword=${param.keyword}&seq=${param.seq }'">이전으로</button>
							</div>
						</form>
					</div>
