						...
						<div class="container col-md-12">
							<div class="card">
								...
								<div class="card-body">
									...
									<p>
										<a href="../sourceBoard/fileDown/${files.upSeq}/${files.seq}">${files.fileRealName}</a>
									</p>
									</c:forEach>
									</div>
								</div>
...
function getRepliesPaging(page) {
	...
	$.getJSON("../SoReplies/" + seq + "/" + page, function (data) {
		console.log(data);
		var str = "";
