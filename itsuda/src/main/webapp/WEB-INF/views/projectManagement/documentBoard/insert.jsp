		...
		<div id="content-wrapper">
			<div class="container-fluid">
				...
				<div class="card-header">
						<i class="fas fa-table"></i> 산출 문서 등록
					</div>
					<div class="card-body">

						<form action="<c:url value='/documentBoard/DoInsertAction'/>"
							method="post" enctype="multipart/form-data">
							<input name="proSeq" type="hidden" value="${param.proSeq}" />
							<div>
								...
								<button type="button" class="btn btn-secondary" style="margin-top:15px; float:right;"
									onclick="location.href='../documentBoard/DoMain?page=${param.page }&perPageNum=10&keyword=&proSeq=${proSeq }'">목록으로</button>
