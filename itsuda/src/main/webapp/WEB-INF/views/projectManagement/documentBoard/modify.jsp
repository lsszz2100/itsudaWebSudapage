		...
		<div id="content-wrapper">
			<div class="container-fluid">
				...
				<div class="card-header">
						<i class="fas fa-table"></i> 산출 문서 수정
					</div>
					<div class="card-body">

						<form action="../documentBoard/DoModifyAction" method="post" enctype="multipart/form-data">
							...
							<div>
								...
								<button type="button" class="btn btn-secondary"
									onclick="location.href='../documentBoard/DoDetail?page=${param.page}&perPageNum=${param.perPageNum}&keyword=${param.keyword}&seq=${param.seq }&proSeq=${proSeq}'">이전으로</button>
							</div>
						</form>
					</div>
...
function modifyBtn_click(upSeq, seq, proSeq) {
	if(confirm("첨부파일을 삭제하겠습니까?")){
		location.href='../documentBoard/fileDelete/'+ upSeq + '/' +seq + '/' +proSeq;
	}
}
