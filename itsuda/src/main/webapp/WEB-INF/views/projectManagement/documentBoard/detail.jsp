							...
							<div class="card">
								...
								<div class="card-body">
									<button type="button" class="btn btn-info" 
										onclick="location.href='../documentBoard/DoModify?page=${param.page}&perPageNum=${param.perPageNum}&keyword=${param.keyword}&seq=${param.seq}&proSeq=${proSeq}'">수정</button>
									<button type="button" class="btn btn-info" 
										onclick="location.href='../documentBoard/DoDelete?page=${param.page}&perPageNum=${param.perPageNum}&keyword=${param.keyword}&seq=${param.seq}&proSeq=${proSeq}'">삭제</button>
									<button type="button" class="btn btn-info"
										onclick="location.href='../documentBoard/DoMain?page=${param.page}&perPageNum=${param.perPageNum}&keyword=${param.keyword}&proSeq=${proSeq}'">목록으로</button>
								</div>
								...
								<div class="card-body">
									...
									<p>
										<a href="../documentBoard/fileDown/${files.upSeq}/${files.seq}">${files.fileRealName}</a>
									</p>
									</c:forEach>
									</div>
								</div>
...
function getRepliesPaging(page) {
	...
	$.getJSON("../DoReplies/" + seq + "/" + page, function (data) {
		console.log(data);
		var str = "";
