							...
							<div class="card">
								...
								<div class="card-body">
									<button type="button" class="btn btn-info" 
										onclick="location.href='../documentBoard/DoModify?page=${param.page}&perPageNum=${param.perPageNum}&keyword=${param.keyword}&seq=${param.seq}'">수정</button>
									<button type="button" class="btn btn-info" 
										onclick="location.href='../documentBoard/DoDelete?page=${param.page}&perPageNum=${param.perPageNum}&keyword=${param.keyword}&seq=${param.seq}'">삭제</button>
									<button type="button" class="btn btn-info"
										onclick="location.href='../documentBoard/DoMain?page=${param.page}&perPageNum=${param.perPageNum}&keyword=${param.keyword}'">목록으로</button>
								</div>
