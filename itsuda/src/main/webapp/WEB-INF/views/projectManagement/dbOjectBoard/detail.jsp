							...
							<div class="card">
								...
								<div class="card-body">
									<button type="button" class="btn btn-info" 
										onclick="location.href='../dbOjectBoard/DBModify?page=${param.page}&perPageNum=${param.perPageNum}&keyword=${param.keyword}&seq=${param.seq}&proSeq=${proSeq }'">수정</button>
									<button type="button" class="btn btn-info" 
										onclick="location.href='../dbOjectBoard/DBDelete?page=${param.page}&perPageNum=${param.perPageNum}&keyword=${param.keyword}&seq=${param.seq}&proSeq=${proSeq }'">삭제</button>
									<button type="button" class="btn btn-info"
										onclick="location.href='../dbOjectBoard/DBMain?page=${param.page}&perPageNum=${param.perPageNum}&keyword=${param.keyword}&proSeq=${proSeq }'">목록으로</button>
								</div>
								...
								<div class="card-body">
									...
									<p>
										<a href="../dbOjectBoard/fileDown/${files.upSeq}/${files.seq}">${files.fileRealName}</a>
									</p>
									</c:forEach>
									</div>
								</div>
...
function getRepliesPaging(page) {
	...
	$.getJSON("../DBReplies/" + seq + "/" + page, function (data) {
		console.log(data);
		var str = "";
