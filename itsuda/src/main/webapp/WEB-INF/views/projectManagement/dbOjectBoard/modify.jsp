						...
						<form action="../dbOjectBoard/DBModifyAction" method="post" enctype="multipart/form-data">
							...
							<div>
								...
								<button type="button" class="btn btn-secondary"
									onclick="location.href='../dbOjectBoard/DBDetail?page=${param.page}&perPageNum=${param.perPageNum}&keyword=${param.keyword}&seq=${param.seq }'">이전으로</button>
							</div>
						</form>
					</div>
...
function modifyBtn_click(upSeq, seq) {
	if(confirm("첨부파일을 삭제하겠습니까?")){
		location.href='../dbOjectBoard/fileDelete/'+ upSeq + '/' +seq;
	}else{
	}
}
</script>
